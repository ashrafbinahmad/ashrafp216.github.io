data = {
    ...
    tabs: {
        ...
        Program_Structure: "The program is designed for two years, full time, post graduate degree organized in four semesters. <br><br> <small> <i class='fa fa-solid fa-circle'></i> </small>  Students with thesis mode should cover four specialization papers from their department and only two (one in one semester) from their sister department of the kulliya within four semesters.    <br><br>  <small> <i class='fa fa-solid fa-circle'></i> </small>   Students with course only mode should cover six specialization papers from their department and only two (one in one semester) from their sister department of the kulliya within four semesters. <br><br> Students are also requested to cover ve block papers (Qur'an, Hadith, Fiqh, General and Elective) consisting of 19 papers within four semesters. In Qur'an block students have to cover only three papers while in the Elective block they can enjoy the selection of 4 papers from 8 provided papers. <br> Taking a paper from each block except from the Qur'an block is mandatory   ",
